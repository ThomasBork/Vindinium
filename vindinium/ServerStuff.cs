            ...
            for(int i = 0;i < charData.Length;i += 2)
            {
                switch (charData[i])
                {
                    ...
                    case '$':
                        ...
                        {
                            case '-':
                                typ = TileType.GOLD_MINE_NEUTRAL;
                                break;
                            case '1':
                                typ = TileType.GOLD_MINE_1;
                                break;
                            case '2':
                                typ = TileType.GOLD_MINE_2;
                                break;
                            case '3':
                                typ = TileType.GOLD_MINE_3;
                                break;
                            case '4':
                                typ = TileType.GOLD_MINE_4;
                                break;
                        }
                        break;
                }
                ...
                if(B.Tiles[x][y] == null)
                {
                    B.Tiles[x][y] = new Tile(typ, x, y);
                }
                else
                {
                    B.Tiles[x][y].Type = typ;
                }
